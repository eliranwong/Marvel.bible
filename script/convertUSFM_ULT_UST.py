...
# remove lines
newData = re.sub(r'([^\n])\\', r'\1\n\\', newData, flags=re.M)
newData = re.sub(r'(\\\*|\\w\*)', r'', newData, flags=re.M)
newData = re.sub(r'^\\zaln-e\\\*', r'', newData, flags=re.M)
newData = re.sub(r'^\\(id|h|toc|mt|zaln).*?$', r'', newData, flags=re.M)
...
# remove \s5
newData = re.sub(r'^\\s5', r'', newData, flags=re.M)
...
newData = re.sub(r'^\\nb$', r'', newData, flags=re.M)
newData = re.sub(r'^\\cl.*?$', r'', newData, flags=re.M)
newData = re.sub('^<br>s Book (One|Two|Three|Four|Five)$', r'', newData, flags=re.M)

newData = re.sub(r'\\fqa (.*?)$', r' <i>\1</i>', newData, flags=re.M)
newData = re.sub(r'\\fqa\* ', r'', newData, flags=re.M)
newData = re.sub(r'\\fqa\*', r'', newData, flags=re.M)
newData = re.sub(r'\\f \+', r' [', newData, flags=re.M)
newData = re.sub(r'\\ft', r'', newData, flags=re.M)
newData = re.sub(r'\\f\*', r' ]', newData, flags=re.M)
